...
public class AndFixManager {
    ...
    public AndFixManager(Context context) {
        ...
        if (mSupport) {
            // mSecurityChecker = new SecurityChecker(mContext); lazy init
    ...
    public synchronized void fix(File file, ClassLoader classLoader,
        ...
        if (!getSecurityChecker().verifyApk(file)) {// security check fail
            return;
        }
        ...
        try {
            ...
            if (optfile.exists()) {
                ...
                if (getSecurityChecker().verifyOpt(optfile)) {
            ...
            if (saveFingerprint) {
                getSecurityChecker().saveOptSig(optfile);
            }
    ...
    public synchronized SecurityChecker getSecurityChecker() {
        if (mSecurityChecker == null) {
            mSecurityChecker = new SecurityChecker(mContext);
        }
        return mSecurityChecker;
    }
